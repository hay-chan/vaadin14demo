package com.blerter.dao.bookstore.ui.inventory;

import com.blerter.dao.bookstore.authentication.AccessControl;
import com.blerter.dao.bookstore.authentication.AccessControlFactory;
import com.blerter.dao.bookstore.backend.DataService;
import com.blerter.dao.bookstore.backend.data.Product;
import com.blerter.dao.bookstore.ui.ChekovViewLogic;
...
public class InventoryViewLogic extends ChekovViewLogic<InventoryView.InventoryParam>
{
    ...
    public InventoryViewLogic(InventoryView simpleCrudView) {
        super( simpleCrudView );
        view = (InventoryView) getChekovView();
    }
